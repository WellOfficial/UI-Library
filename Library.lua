...
local SerLib = Instance.new("ScreenGui")

SerLib.Name = "SERLIB"
SerLib.Parent = game:GetService("CoreGui").RobloxGui.Modules.Profile
SerLib.ZIndexBehavior = Enum.ZIndexBehavior.Sibling
...
function Ui:Window(text) 
    ...
    Logo.Image = "http://www.roblox.com/asset/?id=12005545739"
    ...
    ButtonSetttings.MouseButton1Down:Connect(function()
        if toggonsetting == false then
            ...
            TweenService:Create(
                ...
                {BackgroundColor3 = Color3.fromRGB(212, 180, 100)}
            ):Play()
    ...
    function SettingsToggle(text,default,callback)
        ...
        ToggleSet_UIStroke.Color = Color3.fromRGB(212, 180, 100)
        ...
        Tgle.ImageColor3 = Color3.fromRGB(212, 180, 100)
    ...
    function SettingsButton(text,callback)
        ...
        BtnFrameSetting.BackgroundColor3 = Color3.fromRGB(212, 180, 100)
    ...
    function Tab:CraftTab(text)
        ...
        function Page:CraftPage(text,Type)
            ...
            function Item:Button(text,callback)
                ...
                Button.BackgroundColor3 = Color3.fromRGB(212, 180, 100)
            ...
            function Item:Slider(text,floor,min,max,de,callback)
                ...
                MainValue.BackgroundColor3 = Color3.fromRGB(212, 180, 100)
                ...
                ConneValue.BackgroundColor3 = Color3.fromRGB(212, 180, 100)
            ...
            function Item:Dropdown(text,item,default,callback)
                ...
                for i,v in pairs(item) do
                    ...
                    Item.BackgroundColor3 = Color3.fromRGB(212, 180, 100)
            ...
            function Item:ToggleS(text,default,callback)
                ...
                ToggleSInner.BackgroundColor3 = Color3.fromRGB(212, 180, 100)
            ...
            function Item:Seperator(text)
                ...
                Liner1.BackgroundColor3 = Color3.fromRGB(212, 180, 100)
                Liner1.Position = UDim2.new(0.0620437972, 0, 0.5, 0)
                Liner1.Size = UDim2.new(0, 64, 0, 1)

                LIner2.Name = "LIner2"
                LIner2.Parent = SepFrame
                LIner2.BackgroundColor3 = Color3.fromRGB(212, 180, 100)
            ...
            function Item:Line(text)
                ...
                Liner.BackgroundColor3 = Color3.fromRGB(212, 180, 100)
            ...
            function Item:Toggle(text,default,callback)
                ...
                Toggle_UIStroke.Color = Color3.fromRGB(212, 180, 100)
                ...
                ToggleInner.ImageColor3 = Color3.fromRGB(212, 180, 100)
